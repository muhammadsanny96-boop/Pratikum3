...
class Latihan4 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val buttonBebek = findViewById<Button>(R.id.buttonBebek)
        val bebek = findViewById<LinearLayout>(R.id.bebek)

        buttonBebek.setOnClickListener {
            val input = etJumlahBebek.text.toString().toIntOrNull() ?: 0
            val JumlahBebek = input.coerceIn(1, 6)
            bebek.removeAllViews()
